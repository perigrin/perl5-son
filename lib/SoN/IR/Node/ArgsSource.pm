...
# ABOUTME: Distinct from StashAccess: an argument list, not a name defined outside.
use 5.42.0;
use utf8;
...
# array *main::_. That was true and useless: StashAccess's job after the
...
# StashAccess can mean one thing (and be renamed to EntryDef).
#
